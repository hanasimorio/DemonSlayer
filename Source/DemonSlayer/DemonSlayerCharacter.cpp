...
void ADemonSlayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ADemonSlayerCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ADemonSlayerCharacter::TouchStopped);
...
{
	// If DemonSlayer is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in DemonSlayer.Build.cs is not automatically propagated
...
void ADemonSlayerCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ADemonSlayerCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
